    ...
    <section className="w-full p-8">
      <div className="border mx-auto w-full md:w-[35rem] p-4 rounded-md ">
        <form>
          ...
          <div className="flex felx-col md:flex-row justify-between md:w-[12rem] mt-12">
            <button className=" px-4 py-2 rounded-md bg-blue-500 text-white font-bold hover:shadow-md">
              Login
            </button>
            <button className=" px-4 py-2 rounded-md bg-blue-500 text-white font-bold hover:shadow-md">
              Register
